<template>
    <div id="PrimarySymbolBeginner">
        ...
        <div class="category" v-for="ty of types" :key="ty">
            <h2>{{"Beginner " + ty + " Documentation"}}</h2>
...
import meta from '../meta_primary_symbol_beginner.json';
...
export default class PrimarySymbolBeginner extends Vue
{
    options = ['Text']
